...
print("Simulations round 2 PROTOCOL 4")
...
# Load pickle data
posterior_name = "P4_r1_fixed_exc_posterior_rsqrt90"
...
# P1 & P4observation rsqrt = 1
observation = torch.zeros(1, ) + 1 
# P2 observation sbd = 1
#observation = torch.zeros(3, ) + 1

# Proposal - the samples from the posterior become the new prior (pi_2)
prior_2 =  posterior_r1.set_default_x(observation)
...
np.savez(f'saved/mini_sim/P4_r2_fixed_exc_data_rsqrt90_{task_id}.npz', theta=theta_2, x=x_2)
